...
uint256 hashGenesisBlock("0x73bcc91c744e9f53b09a16a163efa94f322af8b6b751d42c749b1f40c40137a9");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // LaVidaCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "LaVidaCoin Signed Message:\n";
...
{
    // LaVidaCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 7659999999;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 5000000); // LaVidaCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 600; // LaVidaCoin: 3.5 days
static const int64 nTargetSpacing = 30; // LaVidaCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // LaVidaCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // LaVidaCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // LaVidaCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x041582b1b9f16f38b5165bf07869d376b6a4e734d80a068db901db31341fe23d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "step mother of coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 7659999999;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("e0afe37dbd392b9bf8c87746d92e40b4b6a236402ad4935125905b874d6f8319b2ab3f6ad65e738b8123767f21b014e954f5b5d92add3afebba33c020bbaefb119") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1536102162;
        block.nBits    = 504365644;
        block.nNonce   = 1023304675;

        if (fTestNet)
        {
            block.nTime    = 1536102162;
            block.nNonce   = 1419360294;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xcee6139a2df7e3214b645695f6de8b432ad599bbe6986f23be516a434f803f13"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // LaVidaCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LaVidaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LaVidaCoinMiner : ProcessBlock, block not accepted");
    }
